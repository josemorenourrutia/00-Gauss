...
var require_Extra = __commonJS({
  "node_modules/nerdamer/Extra.js"(exports, module) {
    ...
    (function() {
      "use strict";
      var core = nerdamer.getCore(), _ = core.PARSER, Symbol = core.Symbol, format = core.Utils.format, isVector = core.Utils.isVector, isArray = core.Utils.isArray, Vector = core.Vector, S = core.groups.S, EX = core.groups.EX, CP = core.groups.CP, CB = core.groups.CB, FN = core.groups.FN;
      ...
      var __ = core.Extra = {
        ...
        LaPlace: {
          ...
          transform: function(symbol, t, s) {
            ...
            var retval, coeff = symbol.stripVar(t), g = symbol.group;
            ...
            if (symbol.isConstant() || !symbol.contains(t, true)) {
              ...
              if (symbol.group === FN && fns.indexOf(symbol.fname) !== -1 && (symbol.args[0].group === S || symbol.args[0].group === CB)) {
                ...
                if (depth_is_lower) {
                  var integration_depth = core.Settings.integration_depth;
                  ...
                  if (!num.contains(s)) {
                    ...
                    if (f2.x.isComposite()) {
                      ...
                      var symbols = num.collectSymbols(function(x) {
                        ...
                        var t2 = core.Utils.decompose_fn(x, s, true);
                        t2.symbol = x;
                        return t2;
                      }).sort(function(a2, b2) {
                        var p1, p2;
                        p1 = a2.x.value !== s ? 0 : a2.x.power;
                        p2 = b2.x.value !== s ? 0 : b2.x.power;
                        return p2 - p1;
                      });
                      a = new Symbol(-1);
        ...
        Statistics: {
          ...
          gVariance: function(k, args) {
            var x_ = __.Statistics.mean.apply(__.Statistics, args), sum = __.Statistics.sum(args, x_);
...
export default require_Extra();
//# sourceMappingURL=nerdamer_Extra.js.map
